...
void setup() {
  ...
  lcd.backlight();
  Serial.begin(9600);
  Serial.println("WH2 Temperature Decoder");
  lcd.setCursor(0,0);
  lcd.print("WH2 Temperature");
  lcd.setCursor(2,1);
  lcd.print("Decoder V1.0");
...
void loop() {
  ...
  if (wh2_flags) {
    if (wh2_accept()) {
      ...
      Serial.print("% | ");
      Serial.print("Temp: ");
      Serial.print(wh2_temperature()*0.1);
      Serial.print(" | ");
      Serial.print("Data: ");
      ...
      lcd.setCursor(1,0);
      lcd.print("Temp : ");
      lcd.print(wh2_temperature()*0.1);
      lcd.print("C");
      lcd.setCursor(0,1);
      lcd.print("ID:0x");
      lcd.print(wh2_sensor_id(), HEX);
      lcd.setCursor(10,1);
      lcd.print("Rh:");
      lcd.print(wh2_humidity(), DEC);
      lcd.print("%");
      lcd.setCursor(0,2);
